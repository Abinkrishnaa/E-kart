...
import { Badge, Container, Nav, Navbar,Form } from 'react-bootstrap'
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <i class="fa-solid fa-heart text-danger"></i>Wishlist <Badge bg="success rounder ms-2">{wishlistCount}</Badge></Link>
            ...
            <i class="fa-solid fa-cart-shopping  text-warning"></i>Cart <Badge bg="success rounder ms-2">{cartCount}</Badge></Link>
            </Nav.Link>
